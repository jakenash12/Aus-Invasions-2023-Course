...
# Guild abundance and  diversity metrics
write.csv(guild_summary_16S_final, paste(filepath, "Guild_rel_abunds_unpooled_16S.csv", sep=""))
write.csv(guild_summary_16S_pool_final, paste(filepath, "Guild_rel_abunds_pooled_16S.csv", sep=""))
write.csv(guild_richness_16S_final, paste(filepath, "Guild_richness_unpooled_16S.csv", sep=""))
write.csv(guild_richness_16S_pool_final, paste(filepath, "Guild_richness_pooled_16S.csv", sep=""))
```
