...
otu.its =
  read_delim("Aus-Invasions-2023-Course/Aus23_ITS_Metabarcoding/OTUTables/OtuMatITS_rare.csv", delim=",") %>%
...
# save as csv
write.csv(otu.genus.its, "Aus-Invasions-2023-Course/Aus23_ITS_Metabarcoding/OTUTables/OtuMatITS_rare_byGenus.csv")
...
# save as csv
write.csv(otu.genus.16S, "Aus-Invasions-2023-Course/Aus23_16S_Metabarcoding/OTUTables/OtuMat16S_rare_byGenus.csv")
