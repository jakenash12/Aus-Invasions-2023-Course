...
dbrda_bac = capscale(formula = Bac ~ Soil_N + Soil_P + Soil_Moisture + Tree_DBH + Litter_Depth + Pine_Litter_Proportion + Litter_Biomass, data=Meta, distance = "robust.aitchison", sqrt.dist=TRUE)
print(dbrda_bac) 
...
```{r}
#Formula (7 explanatory variables, may risk being overdetermined given small sample size)
dbrda_fung = capscale(formula = Fung ~ Soil_N + Soil_P + Soil_Moisture + Tree_DBH + Litter_Depth + Pine_Litter_Proportion + Litter_Biomass, data=Meta, distance = "robust.aitchison", sqrt.dist=TRUE)
print(dbrda_fung) 
...
```{r}
#Formula (7 explanatory variables, may risk being overdetermined given small sample size)
dbrda_amf = capscale(formula = AMF ~ Soil_N + Soil_P + Soil_Moisture + Tree_DBH + Litter_Depth + Pine_Litter_Proportion + Litter_Biomass, data=Meta, distance = "robust.aitchison", sqrt.dist=TRUE)
print(dbrda_amf) 
...
#Plotting amfal dbRDA with subset of env predictors (significant predictors in bold, insig in black)
```{r}
### Plot a dbRDA
